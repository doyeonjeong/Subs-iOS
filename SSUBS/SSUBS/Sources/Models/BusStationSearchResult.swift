...
struct BusStation: Codable {
    ...
    let x, y: Double
    let cid: Int // 도시코드
    let cityName, arsID, stationDo, gu, dong: String // arsID: 버스 정류장 고유번호(5자리) 01-234
    let busInfo: [BusInfo]
    let localStationID, ebid, stationDirectionName: String // ebid: 버스 정류장 고유번호(5자리) 01-234
